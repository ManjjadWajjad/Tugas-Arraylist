...
public class TugasArrayList {
    ...
    public static void MenampilkanDataBuku(ArrayList<VariabelDataBuku> booklist) {
        ...
        for (VariabelDataBuku TabelBuku : booklist) {
            String Indeks = TugasArrayList.KategoriBuku(TabelBuku.Kategori);
            System.out.println(++No + "\t\t" + TabelBuku.Judul + "\t\t" + TabelBuku.Pengarang + "\t\t" + TabelBuku.Penerbit + "\t\t" + TabelBuku.Judul + "\t\t" + Indeks);
        }
        System.out.println("=========================================================================================================");
